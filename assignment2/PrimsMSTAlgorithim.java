...
public class PrimsMSTAlgorithim{
	//Prims Class variables
	Edge[] edgeTo;		//shortest edges
	double[] distTo;	//weight of edges
	boolean[] marked;	//Determines if vertex is alrady in mst
	...
	*/
	public PrimsMSTAlgorithim(double[][] graph){
